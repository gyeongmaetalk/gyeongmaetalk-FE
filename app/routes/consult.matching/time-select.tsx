...
const afternoonSlots: TimeSlot[] = [
  { time: "13:00", label: "1:00" },
  { time: "13:30", label: "1:30" },
  { time: "14:00", label: "2:00" },
  { time: "14:30", label: "2:30" },
  { time: "15:00", label: "3:00" },
  { time: "15:30", label: "3:30" },
  { time: "16:00", label: "4:00" },
  { time: "16:30", label: "4:30" },
  { time: "17:00", label: "5:00" },
  { time: "17:30", label: "5:30" },
  { time: "18:00", label: "6:00" },
  { time: "18:30", label: "6:30" },
  { time: "19:00", label: "7:00" },
  { time: "19:30", label: "7:30" },
  { time: "20:00", label: "8:00" },
        ...
        {slots.map((slot) => (
          <button
            ...
            className={cn(
              ...
              isPastTime(slot.time) && "text-label-disable"
            )}
